...
function addTreesRandomly({
  ...
  var trees = [
    ...
    {
      probability: probSuperBossLeft,
      position_index: 0,
      is_boss: true,
      template: templateBossLeft,
    },
    {
      probability: probSuperBossCenter,
      position_index: 1,
      is_boss: true,
      template: templateBossCenter,
    },
    {
      probability: probSuperBossRight,
      position_index: 2,
      is_boss: true,
      template: templateBossRight,
    },
  ];
  shuffle(trees);
  ...
  tick: function () {
    document.querySelectorAll(".tree").forEach(function (tree) {
      ...
      if (
        ...
        tree.children[1].setAttribute(
          "from",
          position.x + " 0.6 " + position.z
        );
